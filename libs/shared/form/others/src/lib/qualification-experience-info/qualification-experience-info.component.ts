...
@Component({
  selector: 'ksp-qualification-experience-info',
  templateUrl: './qualification-experience-info.component.html',
  styleUrls: ['./qualification-experience-info.component.scss'],
  providers: providerFactory(QualificationExperienceInfoComponent),
})
export class QualificationExperienceInfoComponent
