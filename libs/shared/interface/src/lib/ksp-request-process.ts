export class KspRequestProcess {
  //id?: string | null = null;
  requesttable?: string | null = null; // SCH_REQUEST, UNI_REQUEST_DEGREE_CERT table แบบคำขอ
  requestid?: string | null = null; // id แบบคำขอ
  ...
  paymentstatus: string | null = null; // สถานะการชำระเงิน ในกรณีที่แบบคำขอมีค่าธรรมเนียม default = 0
