...
@UntilDestroy()
@Component({
  selector: 'ksp-e-qualification-confirm',
  templateUrl: './e-qualification-confirm.component.html',
  styleUrls: ['./e-qualification-confirm.component.scss'],
})
export class EQualificationConfirmComponent implements OnInit {
  requestId!: number;
