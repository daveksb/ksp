...
@Component({
  selector: 'ksp-renew-license-guaruntee-confirm',
  templateUrl: './renew-license-guaruntee-confirm.component.html',
  styleUrls: ['./renew-license-guaruntee-confirm.component.scss'],
})
export class RenewLicenseGuarunteeConfirmComponent
