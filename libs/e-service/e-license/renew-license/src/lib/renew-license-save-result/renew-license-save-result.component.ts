...
@Component({
  selector: 'ksp-renew-license-save-result',
  templateUrl: './renew-license-save-result.component.html',
  styleUrls: ['./renew-license-save-result.component.scss'],
})
export class RenewLicenseSaveResultComponent implements OnInit {
