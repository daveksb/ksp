...
@Component({
  selector: 'ksp-knowledge-cert-detail',
  templateUrl: './knowledge-cert-detail.component.html',
  styleUrls: ['./knowledge-cert-detail.component.scss'],
})
export class KnowledgeCertDetailComponent implements OnInit {
