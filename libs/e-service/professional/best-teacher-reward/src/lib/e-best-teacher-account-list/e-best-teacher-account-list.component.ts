...
@Component({
  selector: 'ksp-e-best-teacher-account-list',
  templateUrl: './e-best-teacher-account-list.component.html',
  styleUrls: ['./e-best-teacher-account-list.component.scss'],
})
export class EBestTeacherAccountListComponent implements AfterViewInit {
  ...
  createGroup() {
    this.router.navigate(['/best-teacher', 'create-account']);
  }
}
