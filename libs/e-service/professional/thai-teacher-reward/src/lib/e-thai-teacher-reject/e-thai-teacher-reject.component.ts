...
@Component({
  selector: 'ksp-e-thai-teacher-reject',
  templateUrl: './e-thai-teacher-reject.component.html',
  styleUrls: ['./e-thai-teacher-reject.component.scss'],
})
export class EThaiTeacherRejectComponent implements OnInit {
