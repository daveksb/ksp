...
@Component({
  selector: 'ksp-e-senior-teacher-create-account',
  templateUrl: './e-senior-teacher-create-account.component.html',
  styleUrls: ['./e-senior-teacher-create-account.component.scss'],
})
export class ESeniorTeacherCreateAccountComponent
  implements OnInit, AfterViewInit
{
  ...
  prev() {
    this.router.navigate(['/senior-teacher', 'account-list']);
  }
