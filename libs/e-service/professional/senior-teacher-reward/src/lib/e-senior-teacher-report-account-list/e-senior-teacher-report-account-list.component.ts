...
@Component({
  selector: 'ksp-e-senior-teacher-report-account-list',
  templateUrl: './e-senior-teacher-report-account-list.component.html',
  styleUrls: ['./e-senior-teacher-report-account-list.component.scss'],
})
export class ESeniorTeacherReportAccountListComponent implements AfterViewInit {
