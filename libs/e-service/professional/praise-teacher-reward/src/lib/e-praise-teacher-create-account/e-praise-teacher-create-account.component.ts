...
@Component({
  selector: 'ksp-e-praise-teacher-create-account',
  templateUrl: './e-praise-teacher-create-account.component.html',
  styleUrls: ['./e-praise-teacher-create-account.component.scss'],
})
export class EPraiseTeacherCreateAccountComponent
  implements OnInit, AfterViewInit
{
  ...
  prev() {
    this.router.navigate(['/praise-teacher', 'account-list']);
  }
