...
@Component({
  selector: 'ksp-e-praise-teacher-reject',
  templateUrl: './e-praise-teacher-reject.component.html',
  styleUrls: ['./e-praise-teacher-reject.component.scss'],
})
export class EPraiseTeacherRejectComponent implements OnInit {
