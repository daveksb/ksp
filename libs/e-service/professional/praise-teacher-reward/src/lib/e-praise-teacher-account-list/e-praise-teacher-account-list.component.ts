...
@Component({
  selector: 'ksp-e-praise-teacher-account-list',
  templateUrl: './e-praise-teacher-account-list.component.html',
  styleUrls: ['./e-praise-teacher-account-list.component.scss'],
})
export class EPraiseTeacherAccountListComponent implements AfterViewInit {
  ...
  createGroup() {
    this.router.navigate(['/praise-teacher', 'create-account']);
  }
}
