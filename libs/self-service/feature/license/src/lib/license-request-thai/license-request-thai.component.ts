...
@UntilDestroy()
@Component({
  selector: 'self-service-license-request-thai',
  templateUrl: './license-request-thai.component.html',
  styleUrls: ['./license-request-thai.component.scss'],
})
export class LicenseRequestThaiComponent
